...
<select name="kategorijaa" id="kategorijaa">
    ...
    <option <?php if($igracka->getKategorija()=="Dečaci"){echo "selected";} ?> value="Dečaci">Dečaci</option>
    <option <?php if($igracka->getKategorija()=="Devojčice"){echo "selected";} ?> value="Devojčice">Devojčice</option>
</select>
