<?php 
    ...
    include "igracka.php";
        ...
        }else{$part2="SELECT * FROM igracke"; }
	 ...
	 while($row=$result->fetch_object()){
        $igracka=new Igracka($row->id,$row->kategorija,$row->naziv,$row->opis,$row->cena,$row->slika);
         ...
         <div class="col span-1-of-3" >
         	...
         	<br><br>
           <a href="#" id="izmeni" onclick="izmeniIgracku(<?php echo $igracka->getId(); ?>)">Izmeni</a>
           <a href="#" id="izbrisi" onclick="izbrisiIgracku(<?php echo $igracka->getId(); ?>)">Izbriši</a>
...
;
	...
	<?php } else{ ?>
           ...
           <br><br>
           <a href="#" id="izmeni" onclick="izmeniIgracku(<?php echo $row->id; ?>)">Izmeni</a>
           <a href="#" id="izbrisi" onclick="izbrisiIgracku(<?php echo $row->id; ?>)">Izbriši</a>
            </div>
